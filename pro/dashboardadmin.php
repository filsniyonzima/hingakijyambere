    ...
    <div id="sidebar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="farmerside.php">FARMER</a>
              <a href="agentdrop.php">AGENT</a>

              <a href="selectsttoreeper.php">STORE KEEPER</a>
        ...
        <option value="">edit users</option>
        <option value="retrievagent.php"><a href="">✏️updateagent</a></option>
        <option value="updatestock.php">✏️updatestock</option>
        <option value="#">✏️updatefarmer</option>
        <option value="#">✏️updaagronomist</option>
        ...
        <div class="dropdown">
            <button class="dropbtn"><select onchange="window.location.href=this.value;">
        <option value="">register users</option>
        <option value="addagronomist.php"><a href="">add agronomist</a></option>
        <option value="regagent.php">register agent</option>
        <option value="formregistfarmer.php">registerfarmer</option>
        <option value="sstorek.php">register storekepper</option>

    </select><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M19.045 7.401c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.378-.378-.88-.586-1.414-.586s-1.036.208-1.413.585L4 13.585V18h4.413L19.045 7.401zm-3-3 1.587 1.585-1.59 1.584-1.586-1.585 1.589-1.584zM6 16v-1.585l7.04-7.018 1.586 1.586L7.587 16H6zm-2 4h16v2H4z"></path></svg>register user
</button>
            <div class="dropdown-content">
              <a href="#">farmer</a>
              <a href="agentdrop.php">AGENT</a>
